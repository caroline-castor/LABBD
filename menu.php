    ...
    <body>
        <div id="lateral">
            <div id="menu">
                ...
                <ul class="box">
                    <li><a href="cadastraPrediosView.php">Cadastrar </a></li>
                    <li><a href="visualizarPredios.php">Visualizar </a></li>
                    <!-- mais links -->
                </ul>
				
				<h3 class="link-titulo">Tipo de Sala</h3>
                <ul class="box">
                    <li><a href="cadastraTipoSalaView.php">Cadastrar </a></li>
                ...
                <ul class="box">
                    <li><a href="cadastraSalaView.php">Cadastrar </a></li>
