...
<html>
    ...
    <body>
        <div id="tudo">
            ...
            <div id="conteudo">
                <h1> Cadastrar Ata </h1>
                <form action="cadastrarAta.php" name="cadastroAta" method="post">
                    <table align="center">
                        <tr valign="baseline">    
                            <td nowrap="nowrap" align="right">Reunião:</td>
                            <td><select name="selecionaReuniaoSemAta">
                                    <?php
                        ...
                        <tr valign="baseline">
                            ...
                            <td>
                                <textarea name="textoDescritivo" rows="25" cols="100" maxlength="1000"></textarea>
                            </td>
                        </tr>
