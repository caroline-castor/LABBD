IF EXISTS (SELECT * FROM sys.objects WHERE type = 'P' AND name = 'p_atualizaTextoDescritivoAta')
...
IF EXISTS (SELECT * FROM sys.objects WHERE type = 'P' AND name = 'p_atualizaComunicacaoPresidencia')
...
IF EXISTS (SELECT * FROM sys.objects WHERE type = 'P' AND name = 'p_atualizaNomeCurso')
...
IF EXISTS (SELECT * FROM sys.objects WHERE type = 'P' AND name = 'p_alteraPauta')
...
IF EXISTS (SELECT * FROM sys.objects WHERE type IN ( N'FN', N'IF', N'TF', N'FS', N'FT' ) AND name = 'f_totalReuniao')
...
IF EXISTS (SELECT * FROM sys.objects WHERE type IN ( N'FN', N'IF', N'TF', N'FS', N'FT' ) AND name = 'f_totalMembros')
...
IF EXISTS (SELECT * FROM sys.objects WHERE type IN ( N'FN', N'IF', N'TF', N'FS', N'FT' ) AND name = 'f_totalMembrosPresentesReuniao')
